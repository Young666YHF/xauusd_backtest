...
from .dollar_trader_martingale_sl import DollarTraderMartingaleSLStrategy, calculate_dollar_trader_martingale_sl_indicators
from .adaptive_trend_strategy import AdaptiveTrendMartingaleStrategy, calculate_adaptive_trend_indicators
from .mean_reversion_martingale import MeanReversionMartingaleStrategy, calculate_mean_reversion_indicators
from .smart_martingale import SmartAdaptiveMartingaleStrategy, calculate_smart_indicators
...
StrategyRegistry.register('dollar_trader_martingale_sl', DollarTraderMartingaleSLStrategy)
